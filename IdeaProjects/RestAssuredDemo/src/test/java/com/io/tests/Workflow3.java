...
public class Workflow3 {
    ...
    public File dataproviderInput= null;
    @BeforeClass
    ...
    @DataProvider(name="propertyFolder")
    public Object[][] getDataFromDataprovider() throws IOException {
        FileInputStream fis=new FileInputStream(".\\src\\test\\payload\\dataProvider.xls");
        XSSFWorkbook workbook= new XSSFWorkbook(fis);
        XSSFSheet sheet=workbook.getSheet("propertyDetails");
    ...
    @Test( dependsOnMethods = "postMasterEntity")
    ...
    @Test(dependsOnMethods = "getMasterID")
    ...
    @Test( dependsOnMethods = "postClientMasterID")
    ...
    @Test(dependsOnMethods = "getClientMasterID")
    ...
    @Test( dependsOnMethods = "postUserID")
    ...
    @Test( dependsOnMethods = "postNewUserLoginTest",dataProvider = "propertyFolder")
    public void postProperty(String foldername) throws IOException {
        payloadFilePath = new File(".\\src\\test\\payload\\"+foldername+"\\property.txt");
        ...
        payloadFilePath = new File(".\\src\\test\\payload\\"+foldername+"\\serviceContractFormData.txt");
        payload = FileUtils.readFileToString(payloadFilePath);
        System.out.println("payload before:"+payload);
        exactpayload=  payload.replace("\"propertyId\":1","\"propertyId\":"+String.valueOf(propertyid));
        System.out.println("payload after:"+exactpayload);
        ...
        payloadFilePath = new File(".\\src\\test\\payload\\"+foldername+"\\insurance.txt");
        payload = FileUtils.readFileToString(payloadFilePath);
        String updatepayload=payload.replace("\"propertyId\":1","\"propertyId\":"+String.valueOf(propertyid));
        exactpayload=updatepayload.replace("\"broker\":1","\"broker\":"+String.valueOf(clientid));
